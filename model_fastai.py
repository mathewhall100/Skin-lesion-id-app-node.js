...
# SETUP HERE
YOUR_CLASSES_HERE = [ 'benign nevi', 'maligmelanoma'] # Your class labels
NAME_OF_PTH_FILE = 'skin_id_model' # Name of your exported `.pth` file
...
class FastaiImageClassifier(object):
    ...
    def setup_model(self, path_to_pth_file, learner_name_to_load, classes, resnet_num=34, tfms=get_transforms(), normalizer=None, **kwargs):
        print(f'initialize model {NAME_OF_PTH_FILE}...')
